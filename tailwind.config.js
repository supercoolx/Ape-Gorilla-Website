  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        green: "rgba(20, 11, 2, 1)",
        "green-10": "rgba(20, 11, 2, .1)",
        "green-60": "rgba(20, 11, 2, .6)",
        "green-90": "rgba(20, 11, 2, .9)",
        "green-dark": "rgba(203, 108, 8, 1)",
        "green-light": "rgba(253, 142, 25, 1)",
        "green-light-60": "rgba(253, 142, 25, .6)",
