...
const HomeRoadmap = () => {
  ...
  const [roadmap] = useState<RoadmapInterface[]>([
    {
      title: "SOFTWARE",
      text: <>We HAVE LAUNCHED Gorilla Build! Get 100% lifetime off for pre-sale buyers! This is a Software as Service to easily build Website, Sales Funnels, Email Marketing Campaigns, Booking Appointment system, Landing pages and more via drag-and-drop functionalities. This software tool serves as a utility to empower the community to create and build online businesses easily, at cost price or free where possible for the community. This software is ready to use at <a href="https://gorillabuild.com" className="text-16 text-orange">GorillaBuild.com</a></>
    },
    {
    ...
    },
    {
      ...
      text: <>We will launch our own “Meta Gorilla” live to earn, and learn to earn mechanisms. We will then launch the second Royal Gorilla NFT Collection, which can only be minted by Ape Gorilla holders, purchasing a “Golden Chalice” to “Evolve” their Ape Gorilla to mint an additional Royal Gorilla NFT.</>
    },
    {
      title: "GAMIFICATION",
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative grid w-full grid-cols-1 py-40 bg-white gap-100 sm:py-60 md:py-100">
          <div className="grid w-full grid-cols-1 gap-40 sm:gap-60">
            ...
            <div className="flex items-center gap-10">
              ...
              >
                <div className="absolute top-0 left-0 w-full transform -skew-x-12 h-50 bg-brown "></div>
                <MdKeyboardArrowLeft className="relative text-white text-24" />
              </button>
              <button
                onClick={() => onStep(1)}
                className="relative flex items-center justify-center h-50 w-80"
              >
                <div className="absolute top-0 left-0 w-full transform -skew-x-12 h-50 bg-brown "></div>
                <MdKeyboardArrowRight className="relative text-white text-24" />
              </button>
            </div>
          </div>
          <div className="flex justify-center w-full">
            <div className="relative w-full">
              <div className="absolute top-[17px] left-[50%] h-2 w-screen translate-x-[-50%] transform overflow-hidden">
                <div className="absolute top-0 bottom-0 left-0 w-full h-2 bg-brown-10"></div>
                ...
                <div className="flex w-max">
                  {roadmap.map((entry: RoadmapInterface, key: number) => (
                    ...
                    >
                      ...
                      <div className="flex justify-start w-full mb-60 sm:mb-40">
                        <div
                        ...
                        >
                          ...
                          >
                            <Wrapper open={step >= key}>
                              <MdCheck className="text-white text-16" />
                            </Wrapper>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="w-full font-regular text-14 text-brown-60 sm:text-16 md:text-18">
                        {entry.text}
                      </div>
                    </div>
                  ))}
