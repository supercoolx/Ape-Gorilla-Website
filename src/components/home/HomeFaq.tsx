...
const HomeFaq = () => {
  const [questions] = useState<QuestionInterface[]>([
    ...
    },
    {
      ...
      answer: (
        <>
          ALOT! The Ape Gorilla NFT not only gives you the entry to an exciting networking community, which organizes
          events all around the world for its holders, but it also will be usable to access our physical club locations
          and VIP areas which are purchased by the Ape Gorilla Club.{" "}
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          Yes, the royalties are 10%, where 5% is exclusively reserved for the community and 5% is returned back to the
          founding team.
        </>
      ),
    },
    {
      ...
      answer: <>Yes, an NFT is a digital property. It is yours until you sell or give it to somebody as a present.</>,
    },
    {
      question: "How can I promote the project?",
      answer: (
        <>
          The best way to promote the project is by inviting people to the Discord channel. If you are an influencer and
          would like to work with us, write to us at support@apegorilla.com
        </>
      ),
    },
  ])
  ...
  return (
    <>
      <div className="w-full grid grid-cols-1 gap-40 sm:gap-60 md:gap-100">
        <div className="w-full flex justify-center">
          <div className="w-[700px] max-w-full grid grid-cols-1 gap-30">
            <div className="w-full text-white text-center font-azo text-24 sm:text-36 md:text-56 leading-[110%]">
